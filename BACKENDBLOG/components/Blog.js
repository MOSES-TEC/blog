...
export default function Blog({ _id }) {
    ...
    async function createBlog (ev) {
        ...
        if (_id)  {
            ...
            toast.success('Blog Data created successfully')
        }
    ...
    const handleSlugChange = (ev) => {
        ...
        const newSlug = inputValue.replace(/\s+/g, '-') // replace spaces with huphens
    ...
    return <>
        <form className="addWebsiteform" onSubmit={createBlog}>
            ...
            <div className="w-100 flex flex-col flex-left mb-2">
                ...
                <input type="text" id="title" value={title} onChange={ev => setTitle(ev.target.value)} placeholder='Enter small title' />
            </div>

            {/* blog slug url */}
            <div className="w-100 flex flex-col flex-left mb-2">
                <label htmlFor="slug">Slug (seo friendly url) </label>
                <input type="text" id="title" value={slug} onChange={handleSlugChange} placeholder='Enter Slug url' />
            </div>
            ...
            <div className="description w-100 flex flex-col flex-left mb-2">
                ...
                <MarkdownEditor
                    ...
                    style={{width: '100%', height: '250px'}} // you can adjust as the height as needed
                    renderHTML={(text) => (
